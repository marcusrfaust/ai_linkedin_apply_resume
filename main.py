...
@click.option('--resume-style', type=str, default='Modern Blue', help='Resume style to adopt without prompting')
def main(collect: False, resume: Path = None, resume_style: str = 'Modern Blue'):
    try:
        ...
        parameters['resume_style'] = resume_style
        
        # Deixar decisão do estilo a cargo dos módulos que consumirem parameters['resume_style']
